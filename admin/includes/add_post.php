...
<?php
    ...
    if(isset($_POST['create_post'])) {
            ...
            move_uploaded_file($post_image_temp, "../images/$ad");
            ...
            $query .= "VALUES({$post_category_id},'{$post_title}','{$post_author}',now(),'{$ad}','{$post_content}','{$post_tags}', '{$post_comment_count}', '{$post_status}') "; 
